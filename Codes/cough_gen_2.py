...
y_cough = y_cough[start:end]
#y_cough_ref =y_cough_filt = butter_bandpass_filter(y_cough[start:end],0.00001,3000,fs)
#sd.play(y_cough[start:end],fs)
...
#compare spectrogram
k = plt.specgram(x = y_cough, Fs=fs,cmap='plasma',vmax=1)
